...
# Import test
from error_evaluator_env import ErrataLocatorEnv
from ref_msg import *
...
def ErrataLocatorTb():
    ...
    test_module = "error_evaluator_test"
    hdl_toplevel = "ErrorEvaluator"
    ...
    verilog_sources.append(proj_path / "RsForney.sv")
